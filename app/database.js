...
class Database {
    ...
    async getAllLearningItems() {
        const selectSQL = 'SELECT * FROM learning_items ORDER BY CASE WHEN status = "todo" THEN 1 WHEN status = "progress" THEN 2 WHEN status = "completed" THEN 3 ELSE 4 END, order_index ASC, created_at DESC';
